...
import static com.oop.projectWithGUI.EmployeeClientsController.selectedClient;

public class EmployeeTransactionsController extends SwitchScenes {
    @FXML
    ...
    public void populateTableView(){
        ...
        // Populate TableView
        tvTransactionHistory.getItems().clear();
